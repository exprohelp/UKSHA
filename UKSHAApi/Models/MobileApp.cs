...
namespace UKSHAApi.Models
{
    ...
    public class PatientInfo : ipMobileApp
    {
        ...
        public string emp_pen_code { get; set; }       
        ...
        public string care_of_type_dec { get; set; }       
        public string rural_urban_ben { get; set; }       
        public string state_name_ben { get; set; }       
        public string district_name_ben { get; set; }       
        public string member_type { get; set; }       
        public string mobile_member { get; set; }       
        public string CentreId { get; set; }       
    ...
    public class PatientDetail : ipMobileApp
    {
        public string TestIds { get; set; }
